 ...
 * 
 * Centralized exception handling for the REST API. This handler intercepts exceptions
 ...
 * - MethodArgumentNotValidException: Request validation errors (Jakarta Validation)
 * - Exception: Catch-all for unexpected errors
 * 
 * Note: In production, consider:
 * - More specific exception types (NotFoundException, UnauthorizedException, etc.)
